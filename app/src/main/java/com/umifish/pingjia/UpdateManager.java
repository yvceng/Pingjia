...
public class UpdateManager
{
    ...
    private boolean isUpdate()
    {
        ...
        Log.i("pingjia","当前软件版本"+versionCode);
        try
        {
        ...
        if (null != mHashMap)
        {
            ...
            Log.i("pingjia","最新软件版本"+serviceCode);
            // 版本判断
    ...
    private int getVersionCode(Context context)
    {
        ...
        try
        {
            ...
            versionCode = context.getPackageManager().getPackageInfo("com.umifish.pingjia", 0).versionCode;
